...
import com.alexanthony.dreambumps.service.util.RandomUtil;
...
public class UserService {
  ...
  public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, SocialService socialService,
      AuthorityRepository authorityRepository, UserCrewMemberService userCrewMemberService,
      UserCrewPriceService userCrewPriceService) {
  ...
  public User createUser(String login, String password, String firstName, String lastName, String email,
    ...
    userCrewMemberService.createMembersForUser(newUser);
    userCrewPriceService.createDetailsForUser(newUser);
  ...
  public User createUser(UserDTO userDTO) {
    ...
    userCrewMemberService.createMembersForUser(user);
    userCrewPriceService.createDetailsForUser(user);
