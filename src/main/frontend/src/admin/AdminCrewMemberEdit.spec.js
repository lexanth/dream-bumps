...
test('Renders properly', () => {
  ...
  const component = shallow(
    <AdminCrewMemberEdit
      ...
      currentMembers={[
        { name: 'Member1', seat: 1 },
        { name: 'Member 2', seat: 2 },
        { name: 'Member 3', seat: 3 }
      ]}
      initialValues={{
        members: [
          { name: 'OldName1', seat: 1 },
          { name: 'Old Name 2', seat: 2 },
          { name: 'Member 3', seat: 3 }
        ]
      }}
    />
...
test('mapStateToProps', () => {
  ...
  expect(componentStateProps).toEqual({
    initialValues: {
      members: [
        { id: 1, name: 'Member 1', crewId: 5 },
        { id: 2, name: 'Member 2', crewId: 5 },
        { id: 4, name: 'Member 4', crewId: 5 }
      ]
    }
  });
});
