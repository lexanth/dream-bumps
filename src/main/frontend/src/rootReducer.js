...
// auth
export const getCurrentUserId = (state: Object) => _getCurrentUserId(state.auth);
...
export const getCrewPriceHistory = (state: Object) => _getCrewPriceHistory(state.crews);
export const getCrewName = (state: Object) => _getCrewName(state.crews);
export const getCrewMemberName = (state: Object) => _getCrewMemberName(state.crews);
...
// config
export const getNumberOfDivisions = (state: Object) => _getNumberOfDivisions(state.config);
export const getNumberOfCrews = (state: Object) => _getNumberOfCrews(state.config);
export const getCrewsPerDivision = (state: Object) => () => state.config.config.crewsPerDivision;
...
export const getUserCrewMembers = (state: Object) => _getUserCrewMembers(state.usercrews);
export const getUserCrewRanking = (state: Object) => _getUserCrewRanking(state.usercrews);
export const getUserCrewRankings = (state: Object) => _getUserCrewRankings(state.usercrews);
export const getBuyMemberId = (state: Object) => _getBuyMemberId(state.usercrews);
...
export const getCurrentStatus = (state: Object) => _getCurrentStatus(state.status);

export const getUserScoreHistory = (state: Object) => _getUserScoreHistory(state.usercrews);
